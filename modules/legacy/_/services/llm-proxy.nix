...
in
{
  ...
  config = lib.mkIf cfg.enable (lib.mkMerge [
    ...
    {
      sops.secrets = {
        llm_proxy_api_key = { mode = "0400"; };
        gemini_api_key = { mode = "0400"; };
        openrouter_api_key_code_agent = { mode = "0400"; };
        minimax_api_key = { mode = "0400"; };
        z_ai_api_key = { mode = "0400"; };
        antigravity_account_1_refresh_token = { mode = "0400"; };
        antigravity_account_1_email = { mode = "0400"; };
        antigravity_account_2_refresh_token = { mode = "0400"; };
        antigravity_account_2_email = { mode = "0400"; };
      };
    }
