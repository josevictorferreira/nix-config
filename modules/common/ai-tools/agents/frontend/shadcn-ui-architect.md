...
Save the implementation plan in `docs/features/{feature_name}/shadcn_ui.md`
...
e.g. I've created a plan at `docs/features/{feature_name}/shadcn_ui.md`, please read that first before you proceed
...
- After you finish the work, MUST create the `docs/features/{feature_name}/shadcn_ui.md` file to make sure others can get full context of your proposed implementation
