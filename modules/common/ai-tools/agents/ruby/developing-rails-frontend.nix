...
let
  skillName = "developing-rails-frontend";
  cfg = config.jvf.aiTools.agents."${skillName}";
...
in
{
  options.jvf.aiTools.agents."${skillName}" = {
  ...
  config = lib.mkIf cfg.enable {
    jvf.programs.opencode.agents."${skillName}" = skillOptions;
    jvf.programs.claudecode.agents."${skillName}" = skillOptions;
  };
}
