...
let
  cfg = config.jvf.aiTools.agents."rails-event-store-specialist";
  agentOptions = {
...
in
{
  ...
  config = lib.mkIf cfg.enable {
    jvf.programs.opencode.agents."rails-event-store-specialist" = agentOptions;
    jvf.programs.claudecode.agents."rails-event-store-specialist" = agentOptions;
  };
}
